...
public class Cursor extends Default {
	...
	public static String saveCursorPosition() {
		return ESCAPE_CODE_DEFAULT + "s";
	}
	
	public static String restoreCursorPosition() {
		return ESCAPE_CODE_DEFAULT + "u";
	}
	
	/**
	 * Returns the code to show the cursor.<br>
	 * Opposite of {@link Cursor#hideCursor() hideCursor}
	 * 
	 * @return The code to show the cursor.
	 */
	public static String showCursor() {
		return ESCAPE_CODE_DEFAULT + "?25h";
	}
	
	/**
	 * Returns the code to hide the cursor.<br>
	 * Opposite of {@link Cursor#showCursor() showCursor}
	 * 
	...
	/**
	 * Returns the code to enable the alternative screen buffer.
	 * 
	 * @return The code to enable the ASB.
	 */
	public static String enableAlternateScreenBuffer() {
		return ESCAPE_CODE_DEFAULT + "?1049h";
	}
	
	/**
	 * Returns the code to disable the alternative screen buffer.
	 * 
	 * @return The code to disable the ASB.
	 */
	public static String disableAlternateScreenBuffer() {
		return ESCAPE_CODE_DEFAULT + "?1049l";
	}
}
